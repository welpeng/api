...
public interface AltDao {
	...
	public void updatePhoneNum(@Param("phoneNum")String phoneNum ,@Param("id")Integer id);

	public List<Alt> getNumCookie(@Param("num")Integer numberCookie);

	public Integer updateBatchUseNum(List<Alt> list);
}
